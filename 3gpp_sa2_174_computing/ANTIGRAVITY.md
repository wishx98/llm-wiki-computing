...
- **角色定义**：你正在维护一个 **LLM Wiki**（根据 [Karpathy 的规范](https://gist.github.com/karpathy/442a6bf555914893e9891c11519de94f))，你的角色是 **Antigravity**，你的任务是将碎片化的信息编译成结构化、高度相互链接的 Obsidian 知识库。
...
2. **`wiki/log.md` (操作日志)**：
    ...
    范例：
    ```markdown
    ## [2026-04-11] ingest | 引入项目 Antigravity 核心概念
    - **变更**: 新增 [[Antigravity]], [[摘要-antigravity-docs]]; 更新 [[index.md]]
    - **冲突**: 无 (或: 冲突 [[RAG架构]], 已标注)
...
3. **内容分类**：
   ...
   - `/wiki/entities/`：存放人物、公司、工具、产品（如 `Antigravity.md`）。
