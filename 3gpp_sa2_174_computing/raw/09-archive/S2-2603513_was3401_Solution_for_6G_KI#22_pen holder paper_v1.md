**3GPP SA WG2#174 S2-2603513**

**Apr. 13th – 17th, 2026 (Revision of S2-2603401)**
...
**Computing Service:** A service provided by 6G network/3rd party utilizing computing resources in computing site to execute application layer workloads.

**Service Hosting Environment**: Environment in the operator domain and fully controlled by the operator, where operator hosted services (e.g., Computing Service, etc.) are offered from.

NOTE: The SHE definition may be extended to include other operator hosted services.

**Computing Site:** TBD.

**Computing Resource:** TBD.

Editor’s note: Other Computing related definitions (e.g., Computing Resource, Computing Site, etc.) are FFS based on the progress of specific solutions.
...
Variant A (Solution #2, 17, 37): CMF exposes Computing Capability to AF;
